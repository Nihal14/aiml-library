        ...
        <>
            <div className="container w-5/6 mx-auto my-3 justify-center flex flex-col">
                ...
                <div className='mx-auto w-full'>
                    <h3 className=' text-lg font-semibold md:text-2xl'>Student Login</h3>
                    <form  onSubmit={handleSignIn}>
                        <input type="text" pattern='4[A-Za-z]{2}\d{2}[A-Za-z]{2}\d{3}' value={formData.username} name='username' onChange={handleOnChange} placeholder="Enter your USN" className="my-3 input input-bordered w-full " /><br />
                        <input type="email" onChange={handleOnChange} value={formData.email} name='email'  pattern='[A-Za-z0-9]+@[A-Za-z\.]+' placeholder="Enter your Email" className="my-3 input input-bordered w-full   " />
                        {error && <AlertMessage message='Please Check your USN or email'/>}
